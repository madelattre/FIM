...
We compute the empirical bias and the root mean squared deviation of each component $(\ell,\ell')$ of the estimated matrix as:
$$
...
```{r}
#| label: tbl-BiasMM
#| tbl-cap: Linear mixed effects model. ...
#| echo: false
#| eval: true
#| warning: false
#| message: false
