...
```{r}
#| label: simuPoissonMixture-resPlots
#| echo: false
#| eval: true
...
```{r}
#| label: tbl-BiasMixt
#| tbl-cap: Poisson mixture model. Empirical bias to the Fisher Information matrix of Isco and Iobs for different values of n.
#| echo: true
#| warning: false
#| message: false
...
```{r}
#| label: tbl-SdMixt
#| tbl-cap: Poisson mixture model. Empirical squared deviation to the Fisher Information matrix of Isco and Iobs for different values of n.
#| echo: true
#| warning: false
#| message: false
