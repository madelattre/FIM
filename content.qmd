...
We now investigate the properties of our algorithm in the curved exponential family when the number of iterations grows (@sec-simuExpo) and the good performance of its extended version in more general latent variable models (@sec-simuNonExpo). We also present a short comparison with existing methods (@sec-simuComparison).

### In curved exponential family model {#sec-simuExpo}
...
### In general latent variable model {#sec-simuNonExpo}
